...
setInterval(function () {
  fetch(`http://127.0.0.1:8000/api/currient_candle`)
    ...
    .catch(err => log(err))
}, 5600); // <-- Увеличивай интервал здесь!
/*

Если задержку не поставить, будет очень много ошибок.
Подробнее про ограничения см здесь: https://tinkoff.github.io/invest-openapi/rest/

5600 (5,6 секунд) - задержка, если есть два токена от двух аккаунтов
11200 (11,2 секунд) - задержка, если есть только один токен
